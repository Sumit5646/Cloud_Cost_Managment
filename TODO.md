...
## Tasks
- [x] Update desktop navigation to include "About" link
- [x] Update mobile menu to include "About" link
- [x] Remove the Live Demo section from the landing page
- [x] Add new About section after the Benefits section
- [x] Test the landing page to ensure proper rendering and navigation
